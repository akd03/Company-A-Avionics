...
pid = PID(50, 2, 0.005, setpoint=0)  # Adjust Kp, Ki, Kd values accordingly
...
adjust_elevator(2,1900)

#time.sleep(2)

adjust_elevator(3,1250) 
#throttle setting (1100 for low pitch, 1250 mid pitch, 1400 for high pitch)
